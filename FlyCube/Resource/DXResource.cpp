...
void DXResource::CommitMemory(MemoryType memory_type)
{
    ...
    auto properties = CD3DX12_HEAP_PROPERTIES(GetHeapType(m_memory_type));
    m_device.GetDevice()->CreateCommittedResource(&properties, flags, &desc, ConvertState(GetInitialState()),
